...
const FAQS = [
  ...
  },
  {
    ...
    a: "Текстовые форматы .txt, .md и любые текстовые файлы объёмом до 200 000 знаков — это примерно 110 страниц А4. Также можно вставить текст прямо в форму: лимит тот же.",
  },
  {
